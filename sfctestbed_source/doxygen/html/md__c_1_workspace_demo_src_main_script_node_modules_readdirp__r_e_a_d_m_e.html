...
<title>demo: readdirp [![Build Status](https://secure.travis-ci.org/thlorenz/readdirp.png)](http://travis-ci.org/thlorenz/readdirp)</title>
...
<div class="title">readdirp [![Build Status](<a href="https://secure.travis-ci.org/thlorenz/readdirp.png">https://secure.travis-ci.org/thlorenz/readdirp.png</a>)](<a href="http://travis-ci.org/thlorenz/readdirp">http://travis-ci.org/thlorenz/readdirp</a>) </div>  </div>
</div><!--header-->
<div class="contents">
...
<p class="startli">Globstars (<code>**</code>) are not supported since specifiying a recursive pattern for an already recursive function doesn't make sense.</p>
...
<p>Demonstrates error handling by listening to events emitted from the readdirp stream and how to pipe the data stream into another destination stream.</p>
<h2>grep</h2>
...
<h2>tests</h2>
<p>The <a href="https://github.com/thlorenz/readdirp/blob/master/test/readdirp.js">readdirp tests</a> also will give you a good idea on how things work. </p>
</div></div><!-- contents -->
<!-- start footer part -->
