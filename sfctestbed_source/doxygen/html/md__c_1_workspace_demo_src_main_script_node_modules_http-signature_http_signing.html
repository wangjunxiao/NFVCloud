...
<div class="contents">
<div class="textblock"><p>This document describes a way to add origin authentication, message integrity, and replay resistance to HTTP REST requests. It is intended to be used over the HTTPS protocol.</p>
...
</pre><h3>Signature Parameters</h3>
<h4>keyId</h4>
...
</pre><h1>Appendix A - Test Values</h1>
...
</pre><h2>Generating and verifying signatures using <code>openssl</code></h2>
...
Verified OK
$
</pre><h2>Generating and verifying signatures using <code>sshpk-sign</code></h2>
