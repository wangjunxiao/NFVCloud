...
<title>demo: 2.3.2 (March 11, 2016)</title>
...
<div class="title">2.3.2 (March 11, 2016) </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><ul>
<li>Fix infinite loop on value parse (#328)</li>
</ul>
<h2>2.3.1 (January 6, 2016)</h2>
<ul>
<li>Added <code>\0</code> IE hack support (#320)</li>
</ul>
<h2>2.3.0 (October 25, 2016)</h2>
<ul>
...
<h2>1.8.1 (March 30, 2016)</h2>
<ul>
<li>Don't remove spaces after function/braces/urls since unsafe (#289)</li>
</ul>
<h2>1.8.0 (March 24, 2016)</h2>
<ul>
<li>Usage data support:<ul>
...
<li>Improve initial ruleset merge<ul>
...
<li>integration improvements<ul>
...
<h2>1.6.1 (February 28, 2016)</h2>
<ul>
<li>fix exception on zero length dimension compress outside declaration (#273)</li>
</ul>
<h2>1.6.0 (February 27, 2016)</h2>
<ul>
<li><b>source maps support</b></li>
<li>parser remake:<ul>
...
<h2>1.5.2 (January 24, 2016)</h2>
<ul>
<li>don't merge rulesets if between them a ruleset with same specificity (#264)</li>
</ul>
<h2>1.5.1 (January 14, 2016)</h2>
<ul>
<li>ensure <code>-</code> is not used as an identifier in attribute selectors (thanks to )</li>
<li>fix broken <code>justDoIt()</code> function</li>
<li>various small fixes</li>
</ul>
<h2>1.5.0 (January 14, 2016)</h2>
<h3>Parser</h3>
<ul>
...
<li>fix typo when specifying options in cli (thanks to )</li>
<li>fix safe unit values merge with keyword values (#244)</li>
<li>fix wrong descendant combinator removal (#246)</li>
<li>build browser version on <code>prepublish</code> (thanks to )</li>
...
<h3>API</h3>
<ul>
<li>new method <code>minify(src, options)</code>, options:<ul>
...
<h2>1.3.7 (February 11, 2013)</h2>
<ul>
<li>Gonzales 1.0.7.</li>
</ul>
<h2>1.3.6 (November 26, 2012)</h2>
<ul>
<li>Gonzales 1.0.6.</li>
</ul>
<h2>1.3.5 (October 28, 2012)</h2>
<ul>
