...
<div class="title">1.5.0 </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><ul>
<li>Q.any gives an error message from the last rejected promise</li>
<li>Throw if callback supplied to "finally" is invalid ()</li>
...
<h2>1.4.0</h2>
<ul>
<li>Add <code>noConflict</code> support for use in <code>&lt;script&gt;</code> ().</li>
</ul>
<h2>1.3.0</h2>
<ul>
<li>Add tracking for unhandled and handled rejections in Node.js ().</li>
</ul>
<h2>1.2.1</h2>
<ul>
<li>Fix Node.js environment detection for modern Browserify ().</li>
</ul>
<h2>1.2.0</h2>
<ul>
<li>Added Q.any(promisesArray) method (). Returns a promise fulfilled with the value of the first resolved promise in promisesArray. If all promises in promisesArray are rejected, it returns a rejected promise.</li>
</ul>
<h2>1.1.2</h2>
<ul>
<li>Removed extraneous files from the npm package by using the "files" whitelist in package.json instead of the .npmignore blacklist. (-rudeshko)</li>
</ul>
<h2>1.1.1</h2>
<ul>
...
<li>Refactors <code>nextTick</code> to use an unrolled microtask within Q regardless of how new ticks a requested. #316 </li>
</ul>
<h2>0.9.5</h2>
<ul>
...
<li>Introduces <code>spawn</code> for an immediately invoked asychronous generator. </li>
...
<h2>0.9.4</h2>
<ul>
<li><code>isPromise</code> and <code>isPromiseAlike</code> now always returns a boolean (even for falsy values). #284 -pt</li>
<li>Support for ES6 Generators in <code>async</code> #288 </li>
<li>Clear duplicate promise rejections from dispatch methods #238 </li>
<li>Unhandled rejection API #296  <code>stopUnhandledRejectionTracking</code>, <code>getUnhandledReasons</code>, <code>resetUnhandledRejections</code>.</li>
</ul>
<h2>0.9.3</h2>
<ul>
<li>Add the ability to give <code>Q.timeout</code>'s errors a custom error message. #270 </li>
...
<h2>0.9.2</h2>
<ul>
<li>Pass through progress notifications when using <code>timeout</code>. #229 </li>
<li>Pass through progress notifications when using <code>delay</code>.</li>
<li>Fix <code>nbind</code> to actually bind the <code>thisArg</code>. #232 </li>
</ul>
<h2>0.9.1</h2>
<ul>
<li>Made the AMD detection compatible with the RequireJS optimizer's <code>namespace</code> option. #225 </li>
<li>Fix side effects from <code>valueOf</code>, and thus from <code>isFulfilled</code>, <code>isRejected</code>, and <code>isPending</code>. #226 </li>
</ul>
<h2>0.9.0</h2>
...
<p>0.8.x method </p>
<p>0.9 replacement  &lt;/thead&gt; &lt;tbody&gt; </p>
<p><code>Q.ref</code> </p>
<p><code>Q</code>  </p>
<p><code>call</code>, <code>apply</code>, <code>bind</code> (*) </p>
<p><code>fcall</code>/<code>invoke</code>, <code>fapply</code>/<code>post</code>, <code>fbind</code>  </p>
<p><code>ncall</code>, <code>napply</code> (*) </p>
<p><code>nfcall</code>/<code>ninvoke</code>, <code>nfapply</code>/<code>npost</code>  </p>
<p><code>end</code> </p>
<p><code>done</code>  </p>
<p><code>put</code> </p>
<p><code>set</code>  </p>
...
<p><code>nbind</code>  </p>
<p><code>nend</code> </p>
<p><code>nodeify</code>  </p>
<p><code>isResolved</code> </p>
<p><code>isPending</code>  </p>
<p><code>deferred.node</code> </p>
<p><code>deferred.makeNodeResolver</code>  </p>
<p><code>Method</code>, <code>sender</code> </p>
<p><code>dispatcher</code>  </p>
<p><code>send</code> </p>
<p><code>dispatch</code>  </p>
<p><code>view</code>, <code>viewInfo</code> </p>
<p>(none)  &lt;/tbody&gt; </p>
<p>(*) Use of <code>thisp</code> is discouraged. For calling methods, use <code>post</code> or <code>invoke</code>.</p>
<h3>Alignment with the Concurrency Strawman</h3>
<ul>
...
<li>The included browser <code>nextTick</code> shim is now faster. #195 .</li>
</ul>
<h3>Bug Fixes</h3>
<ul>
<li>Q now works in Internet Explorer 10. #186 </li>
...
<li><code>keys</code> behavior is now correct even in browsers without native <code>Object.keys</code>. #192 </li>
<li><code>isRejected</code> and the <code>exception</code> property now work correctly if the rejection reason is falsy. #198</li>
</ul>
<h3>Internals and Advanced</h3>
<ul>
...
<li>Fixed <code>Q.timeout</code> to clear its timeout handle when the promise is rejected; previously, it kept the event loop alive until the timeout period expired. #145 </li>
...
<li>Added <code>thenResolve</code> as a shortcut for returning a constant value once a promise is fulfilled. #108 </li>
...
<li>Fixed stack traces getting mangled if they hit <code>end</code> twice. #116 #121 </li>
...
<li>Fixed various cases involving unorthodox rejection reasons. #73 #90 </li>
<li>Fixed double-resolving of misbehaved custom promises. #75</li>
<li>Sped up <code>Q.all</code> for arrays contain already-resolved promises or scalar values. </li>
<li>Made stack trace filtering work when concatenating assets. #93 </li>
<li>Added warnings for deprecated methods. </li>
<li>Added <code>.npmignore</code> file so that dependent packages get a slimmer <code>node_modules</code> directory.</li>
</ul>
<h2>0.8.5</h2>
<ul>
<li>Added preliminary support for long traces ()</li>
...
<li>Support Internet Explorers 7–9 (with multiple bug fixes )</li>
...
<li>Added <code>allResolved</code> for waiting for every promise to either be fulfilled or rejected, without propagating an error.  #53</li>
<li>Added <code>Q.bind</code> as a method to transform functions that return and throw into promise-returning functions. See <a href="https://gist.github.com/1782808">an example</a>. </li>
<li>Renamed <code>node</code> export to <code>nbind</code>, and added <code>napply</code> to complete the set. <code>node</code> remains as deprecated.  #58</li>
...
<h2>0.8.2</h2>
<ul>
<li>Deprecated <code>ref</code> in favor of <code>resolve</code> as recommended by .</li>
<li>Update event-queue dependency.</li>
</ul>
<h2>0.8.1</h2>
<ul>
<li>Fixed Opera bug. #35 </li>
<li>Fixed <code>Q.all([])</code> #32 </li>
</ul>
<h2>0.8.0</h2>
<ul>
...
<h2>0.7.0 - BACKWARD INCOMPATIBILITY</h2>
<ul>
...
<h2>0.6.0 - BACKWARD INCOMPATIBILITY</h2>
<ul>
...
<h2>0.5.0 - MINOR BACKWARD INCOMPATIBILITY</h2>
<ul>
...
<h2>0.4.0 - BACKWARD INCOMPATIBLE*</h2>
<ul>
...
<h2>0.3.0 - BACKWARD-INCOMPATIBLE</h2>
<ul>
...
<h2>0.2.5</h2>
<ul>
<li>Changed promises into a duck-type such that multiple instances of the Q module can exchange promise objects. A promise is now defined as "an object that implements the
   `promiseSend(op, resolved, ...)` method and `valueOf`".</li>
...
<h2>0.2.0 - BACKWARD INCOMPATIBLE</h2>
<ul>
