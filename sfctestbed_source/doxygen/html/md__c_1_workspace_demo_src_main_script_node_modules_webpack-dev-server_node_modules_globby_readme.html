...
<title>demo: globby [![Build Status](https://travis-ci.org/sindresorhus/globby.svg?branch=master)](https://travis-ci.org/sindresorhus/globby)</title>
...
<div class="title">globby [![Build Status](<a href="https://travis-ci.org/sindresorhus/globby.svg?branch=master">https://travis-ci.org/sindresorhus/globby.svg?branch=master</a>)](<a href="https://travis-ci.org/sindresorhus/globby">https://travis-ci.org/sindresorhus/globby</a>) </div>  </div>
</div><!--header-->
<div class="contents">
...
<h2>Install</h2>
<div class="fragment"><div class="line">$ npm install --save globby</div></div><!-- fragment --><h2>Usage</h2>
<div class="fragment"><div class="line">├── unicorn</div><div class="line">├── cake</div><div class="line">└── rainbow</div></div><!-- fragment --><div class="fragment"><div class="line">const globby = require(&#39;globby&#39;);</div><div class="line"></div><div class="line">globby([&#39;*&#39;, &#39;!cake&#39;]).then(paths =&gt; {</div><div class="line">    console.log(paths);</div><div class="line">    //=&gt; [&#39;unicorn&#39;, &#39;rainbow&#39;]</div><div class="line">});</div></div><!-- fragment --><h2>API</h2>
