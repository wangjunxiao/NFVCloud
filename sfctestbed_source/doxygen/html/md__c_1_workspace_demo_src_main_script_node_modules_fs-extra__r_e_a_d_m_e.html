...
<p>Example:</p>
<div class="fragment"><div class="line">const fs = require(&#39;fs-extra&#39;)</div><div class="line"></div><div class="line">// Async with promises:</div><div class="line">fs.copy(&#39;/tmp/myfile&#39;, &#39;/tmp/mynewfile&#39;)</div><div class="line">  .then(() =&gt; console.log(&#39;success!&#39;))</div><div class="line">  .catch(err =&gt; console.error(err))</div><div class="line"></div><div class="line">// Async with callbacks:</div><div class="line">fs.copy(&#39;/tmp/myfile&#39;, &#39;/tmp/mynewfile&#39;, err =&gt; {</div><div class="line">  if (err) return console.error(err)</div><div class="line">  console.log(&#39;success!&#39;)</div><div class="line">})</div><div class="line"></div><div class="line">// Sync:</div><div class="line">try {</div><div class="line">  fs.copySync(&#39;/tmp/myfile&#39;, &#39;/tmp/mynewfile&#39;)</div><div class="line">  console.log(&#39;success!&#39;)</div><div class="line">} catch (err) {</div><div class="line">  console.error(err)</div><div class="line">}</div></div><!-- fragment --><h2>Methods </h2>
<h3>Async</h3>
<ul>
<li><a class="el" href="copy_8md.html">copy</a></li>
<li><a class="el" href="empty_dir_8md.html">emptyDir</a></li>
<li><a class="el" href="ensure_file_8md.html">ensureFile</a></li>
<li><a class="el" href="ensure_dir_8md.html">ensureDir</a></li>
<li><a class="el" href="ensure_link_8md.html">ensureLink</a></li>
<li><a class="el" href="ensure_symlink_8md.html">ensureSymlink</a></li>
<li><a class="el" href="ensure_dir_8md.html">mkdirs</a></li>
<li><a class="el" href="move_8md.html">move</a></li>
<li><a class="el" href="output_file_8md.html">outputFile</a></li>
<li><a class="el" href="output_json_8md.html">outputJson</a></li>
<li><a class="el" href="path_exists_8md.html">pathExists</a></li>
<li><a class="el" href="read_json_8md.html">readJson</a></li>
<li><a class="el" href="remove_8md.html">remove</a></li>
<li><a class="el" href="write_json_8md.html">writeJson</a></li>
</ul>
<h3>Sync</h3>
<ul>
<li><a class="el" href="copy-sync_8md.html">copySync</a></li>
<li><a class="el" href="empty_dir-sync_8md.html">emptyDirSync</a></li>
<li><a class="el" href="ensure_file-sync_8md.html">ensureFileSync</a></li>
<li><a class="el" href="ensure_dir-sync_8md.html">ensureDirSync</a></li>
<li><a class="el" href="ensure_link-sync_8md.html">ensureLinkSync</a></li>
<li><a class="el" href="ensure_symlink-sync_8md.html">ensureSymlinkSync</a></li>
<li><a class="el" href="ensure_dir-sync_8md.html">mkdirsSync</a></li>
<li><a class="el" href="move-sync_8md.html">moveSync</a></li>
<li><a class="el" href="output_file-sync_8md.html">outputFileSync</a></li>
<li><a class="el" href="output_json-sync_8md.html">outputJsonSync</a></li>
<li><a class="el" href="path_exists-sync_8md.html">pathExistsSync</a></li>
<li><a class="el" href="read_json-sync_8md.html">readJsonSync</a></li>
<li><a class="el" href="remove-sync_8md.html">removeSync</a></li>
<li><a class="el" href="write_json-sync_8md.html">writeJsonSync</a></li>
</ul>
<p><b>NOTE:</b> You can still use the native Node.js methods. They are promisified and copied over to <code>fs-extra</code>.</p>
