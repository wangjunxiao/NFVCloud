...
<div class="title">9.12.0 </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><ul>
<li>Added the <code>Option</code> named constructor. (NAlexPear)</li>
<li>Added support for the <code>canvas-prebuilt</code> npm package as an alternative to <code>canvas</code>.</li>
...
<li>Fixed <code>jsdom.env()</code> to preserve <a class="el" href="namespace_u_r_l.html">URL</a> fragments across redirects. (josephfrazier)</li>
...
<li>Changed <code>navigator.vendor</code> to return <code>"Apple Computer, Inc."</code> instead of <code>"Google Inc."</code>, since we have chosen the WebKit <a href="https://html.spec.whatwg.org/multipage/webappapis.html#concept-navigator-compatibility-mode">navigator compatibility mode</a>.</li>
</ul>
<h2>9.9.1</h2>
<ul>
...
<li>Fixed a minor edge-case regression where non-HTML elements with the name <code>"iframe"</code> became focusable in 9.7.0.</li>
</ul>
<h2>9.7.1</h2>
<ul>
...
<li>Tweaked the behavior of calling <code>event.stopPropagation</code> and <code>event.stopImmediatePropagation</code> on already-dispatched events, per <a href="https://github.com/whatwg/dom/commit/806d4aab584f6fc38c21f8e088b51b8ba3e27e20">the latest changes to the DOM Standard</a>.</li>
</ul>
<h2>9.5.0</h2>
<ul>
...
<h2>9.4.5</h2>
<ul>
<li>Fixed <code>"error"</code> events from failed resource loads going missing since 9.4.3. I really should have tested that release better.</li>
</ul>
<h2>9.4.4</h2>
<ul>
<li>Fixed a leftover <code>console.log</code> introduced in the error handling path in 9.4.3.</li>
</ul>
<h2>9.4.3</h2>
<ul>
...
<h2>9.4.0</h2>
<ul>
<li>Added the <code>DOMParser</code> API. It is spec-compliant, including producing <code>&lt;parsererror&gt;</code> elements, except that the produced documents do not have the same <a class="el" href="namespace_u_r_l.html">URL</a> as the creating document (they instead always have <code>"about:blank"</code>).</li>
...
<li>Updated <code>FormData</code> for <a href="https://github.com/whatwg/xhr/commit/1a75845e67792418a7721d516266ad01a90f2062">recent spec fixes</a>: blobs, files, and filenames should now all work like you'd expect.</li>
<li>Updated the <code>FormData</code> constructor to use the proper, rather-complex, <a href="https://html.spec.whatwg.org/multipage/forms.html#constructing-form-data-set">constructing the form data set</a> algorithm.</li>
...
<li>Fixed the loading of external <code>&lt;img&gt;</code>s (when the <code>canvas</code> npm package is installed) that were specified via relative <a class="el" href="namespace_u_r_l.html">URL</a>; this regressed in 9.2.1.</li>
<li>Fixed <code>&lt;iframe&gt;</code> documents to have the correct <code>referrer</code> value (viz. the <a class="el" href="namespace_u_r_l.html">URL</a> of their parent).</li>
...
<h2>9.2.1</h2>
<ul>
<li>Fixed <code>&lt;input&gt;</code>'s <code>selectionStart</code>, <code>selectionEnd</code>, and <code>selectionDirection</code> getters to return null, instead of throwing, for elements that do not allow selection, per <a href="https://github.com/whatwg/html/pull/1006">a recent spec change</a>.</li>
<li>Fixed <code>&lt;base&gt;</code>'s <code>href</code> getter logic to return the attribute value instead of the empty string for unparseable URLs, per <a href="https://github.com/whatwg/html/pull/1064">a recent spec change</a>.</li>
<li>Fixed the referrer sent when retrieving external resources to be the document's <a class="el" href="namespace_u_r_l.html">URL</a>, not the document's base <a class="el" href="namespace_u_r_l.html">URL</a>.</li>
<li>Fixed suppression of all <code>error</code> events on <code>window</code> beyond the first one.</li>
<li>Fixed <code>new <a class="el" href="namespace_u_r_l.html">URL</a></code> to correctly throw for unparseable URLs, and all of <code><a class="el" href="namespace_u_r_l.html">URL</a></code>'s setters to correctly ignore invalid input instead of throwing.</li>
...
<h2>9.2.0</h2>
<ul>
<li>Added <code>jsdom.changeURL(window, newURL)</code> for allowing you to override a window's existing <a class="el" href="namespace_u_r_l.html">URL</a>. (mummybot)</li>
...
<li>Fixed <code>formEl.action</code> to return a value resolved relative to the document <a class="el" href="namespace_u_r_l.html">URL</a>, or to return the document <a class="el" href="namespace_u_r_l.html">URL</a> if the corresponding attribute is missing or empty.</li>
...
<li>Fixed a regression introduced in 9.0.0 where invalid CSS would cause a crash while attempting to parse it. Instead, a <code>"jsdomError"</code> will now be emitted to the virtual console.</li>
</ul>
<h2>9.0.0</h2>
...
<ul>
<li><b>Removed mutation events</b>, as discussed above.</li>
...
<li><code>jsdom.env</code>, when given a <a class="el" href="namespace_u_r_l.html">URL</a> or file, will decode the resulting bytes using signals like the <code>Content-Type</code> header, <code>&lt;meta charset&gt;</code> declaration, or presence of a BOM, in the same manner as web browsers.</li>
...
<li>Fixed a few minor bugs in <a class="el" href="namespace_u_r_l.html">URL</a> parsing and the <code><a class="el" href="namespace_u_r_l.html">URL</a></code> API, by upgrading to <code>whatwg-url</code> 2.0.1.</li>
...
<li>Added a basic implementation of the <a href="https://w3c.github.io/page-visibility/">Page Visibility API</a>, in particular a <code>document.hidden</code> property that always returns <code>true</code>, and a <code>document.visibilityState</code> property that always returns <code>"prerender"</code>. This is a more standard alternative to our proprietary <code>navigator.noUI</code>, which will be removed whenever we release 9.0.0. (kapouer)</li>
</ul>
<h2>8.2.0</h2>
<ul>
...
<h2>8.1.0</h2>
<ul>
<li>Added <code>attr.nodeName</code>, which was <a href="https://github.com/whatwg/dom/issues/171">recently re-added to the spec</a>.</li>
...
<li>Added <code>element.getAttributeNames()</code>. (<a href="https://github.com/whatwg/dom/issues/115">spec addition</a>)</li>
<li><code>setAttributeNode</code> and <code>setAttributeNodeNS</code> can now replace an attribute node, instead of removing the old one and adding a new one; this avoids changing the order in the attribute list. (<a href="https://github.com/whatwg/dom/issues/116">spec change</a>)</li>
<li><code>NamedNodeMap</code> named properties are now lowercase (except in edge cases involving XML documents or non-HTML elements). (<a href="https://github.com/whatwg/dom/issues/141">spec change</a>)</li>
...
<li>Updated <code>DOMTokenList</code> to have a <code>value</code> property per <a href="https://github.com/whatwg/dom/issues/119">recent spec changes</a>; its <code>toString</code> serialization also changed slightly.</li>
...
<li>Removed the <code>"keyevents"</code> alias for <code>"keyboardevent"</code> when using <code>document.createEvent</code>, <a href="https://github.com/whatwg/dom/issues/148">per recent spec changes</a>.</li>
</ul>
<h2>8.0.4</h2>
<ul>
...
<ul>
<li>Reimplemented <code>Location</code>, <code><a class="el" href="interface_history.html">History</a></code>, and <code>HTMLHyperlinkElementUtils</code> (used by both <code>HTMLAnchorElement</code> and <code>HTMLAreaElement</code>) according to the latest specs, and using the latest <a href="https://github.com/jsdom/whatwg-url">whatwg-url</a> package. This greatly improves our correctness on <a class="el" href="namespace_u_r_l.html">URL</a> resolution and navigation (to the extent we support navigation, i.e. <code>pushState</code> and changing the hash). It should also improve parsing speed as we no longer parse and resolve URLs during parsing.</li>
...
<li>Removed <a href="http://www.w3.org/TR/2003/CR-DOM-Level-3-LS-20031107/load-save.html">"DOM Load and Save"</a> stub implementation. That spec was never implemented in browsers, and jsdom only contained stubs.</li>
<li>Removed other minor unimplemented, stub, or no-longer-standard APIs from "DOM Level 3", like the user-data API, <code>DOMException</code>, <code>DOMConfiguration</code>, and <code>DOMStringList</code>.</li>
</ul>
<h2>7.2.2</h2>
<ul>
...
<li>Fixed <code>data:</code> <a class="el" href="namespace_u_r_l.html">URL</a> parsing to allow empty contents, e.g. <code>data:text/css;base64,</code>. (sebmck)</li>
</ul>
<h2>7.2.1</h2>
<ul>
<li>Fixed a regression in XML parsing of attributes with a namespace <a class="el" href="namespace_u_r_l.html">URL</a> but no prefix (e.g. <code>&lt;math xmlns="http://www.w3.org/1998/Math/MathML"&gt;</code>).</li>
</ul>
<h2>7.2.0</h2>
<ul>
...
<h2>7.0.0</h2>
<p>This major release has as its headlining feature a completely re-written <code>XMLHttpRequest</code> implementation, in a heroic effort by <a href="https://github.com/nicolashenry"></a>. It includes a number of other smaller improvements and fixes. The breaking changes are highlighted in bold below.</p>
<ul>
<li><b>Node.js 4.0 onward is now required</b>, as we have begun using ES2015 features only present there.</li>
...
<li><b>Invalid URLs are no longer allowed when creating a jsdom document</b>; the <a class="el" href="namespace_u_r_l.html">URL</a> must be parseable, or an error will be thrown.</li>
<li><b>The <code>{ omitJsdomErrors }</code> option of the virtual console has moved</b>; it is no longer provided when creating the virtual console, but instead when calling <code>sendTo</code>.</li>
</ul>
<h2>6.5.1</h2>
<ul>
...
<li>Added <code>Node.prototype.baseURI</code> property to get the node's owner document's base <a class="el" href="namespace_u_r_l.html">URL</a>.</li>
<li><code>HTMLBaseElement</code>'s <code>href</code> getter now contains appropriate fallbacks and always returns an absolute <a class="el" href="namespace_u_r_l.html">URL</a>, per spec.</li>
<li>If there are no <code>base</code> elements in an <code>"about:blank"</code> iframe document, the base <a class="el" href="namespace_u_r_l.html">URL</a> correctly falls back to the parent window's base <a class="el" href="namespace_u_r_l.html">URL</a>.</li>
</ul>
</li>
<li>When you provide a <code>url: ...</code> option to <code>jsdom.jsom()</code> or <code>jsdom.env()</code>, the given string is now attempted to be resolved as a <a class="el" href="namespace_u_r_l.html">URL</a> before it is installed as <code>document.URL</code>.<ul>
...
<li>In a future major release, we will start throwing if strings that cannot be parsed as valid absolute <a class="el" href="namespace_u_r_l.html">URL</a> are provided for this option.</li>
</ul>
</li>
</ul>
<h2>6.2.0</h2>
...
<h2>6.0.0</h2>
<p>This major release is focused on massive improvements in speed, <a class="el" href="namespace_u_r_l.html">URL</a> parsing, and error handling. The potential breaking changes are highlighted in bold below; the largest ones are around the <code>jsdom.env</code> error-handling paradigm.</p>
<p>This release also welcomes <a href="https://github.com/tmpvar/jsdom/commits/master?author=Joris-van-der-Wel">long-time contributer</a> <a href="https://github.com/Joris-van-der-Wel/">-van-der-Wel</a> to the core team. You may recognize him from earlier changelogs. We're very happy to have his help in making jsdom awesome!</p>
<ul>
<li><b>io.js 2.0 onward is now required</b>, as we have begun using ES2015 features only present there.</li>
...
<li><b>The <code>load(errors, window)</code> callback was changed to <code>onload(window)</code></b>, to reflect that it is now just sugar for setting a <code>window.onload</code> handler.</li>
<li><b>The <code>done(errors, window)</code> callback (i.e., the default callback for <code>jsdom.env</code>) has become <code>done(error, window)</code></b>, and like every other io.js callback now simply gives you a single error object, instead of an array of them.</li>
</ul>
</li>
...
<li><a class="el" href="namespace_u_r_l.html">URL</a> parsing and resolution was entirely overhauled to follow <a href="http://url.spec.whatwg.org/">the URL standard</a>!<ul>
<li>This fixes several long-standing bugs and hacks in the jsdom <a class="el" href="namespace_u_r_l.html">URL</a> parser, which already had a mess of gross patches on top of the built-in io.js parser to be more web-compatible.</li>
<li>The new <a href="https://url.spec.whatwg.org/#url"><code>URL</code> class</a> has been added to <code>window</code></li>
<li>The interfaces for <code>HTMLAnchorElement.prototype</code> and <code>document.location</code> (as well as <code><a class="el" href="namespace_u_r_l.html">URL</a></code>, of course) are now uniformized to follow the <a href="https://url.spec.whatwg.org/#api"><code>URLUtils</code> API</a> (minus <code>searchParams</code> for now).</li>
<li><b>As part of this change, you may need to start passing in <code>file:</code> URLs to <code>jsdom.env</code> where previously you were able to get away with passing in filenames.</b></li>
</ul>
</li>
...
<p>Finally, if you're a loyal jsdom fan whose made it this far into the changelog, I'd urge you to come join us in <a href="https://github.com/tmpvar/jsdom/issues/1139">#1139</a>, where we are brainstorming a modernized jsdom API that could get rid of many of the warts in the current one.</p>
<h2>5.6.1</h2>
<ul>
<li>Fixed an accidentally-created global <code>attribute</code> variable if you ever called <code>createAttributeNS</code>.</li>
<li>Dependency upgrades fixed a couple of bugs, although you would have gotten these anyway with a clean jsdom 5.6.0 install:<ul>
<li>Parsing of CSS properties that use <code>url("quoted string")</code> now works correctly, as of <code>cssstyle</code> 0.2.29.</li>
<li>Selectors for the empty string, like <code>div[title=""]</code>, now work correctly, as of <code>nwmatcher</code> 1.3.6.</li>
</ul>
</li>
</ul>
<h2>5.6.0</h2>
<ul>
<li><code>virtualConsole.sendTo</code> now returns <code>this</code>, allowing for <a href="https://github.com/tmpvar/jsdom/tree/60ccb9b318d0bae8fe37e19af5af444b9c98ddac#forward-a-windows-console-output-to-the-iojs-console">a nice shorthand</a>. (jeffcarp)</li>
</ul>
<h2>5.5.0</h2>
<ul>
...
<li>Document clones now correctly copy over the <a class="el" href="namespace_u_r_l.html">URL</a> and content-type.</li>
</ul>
</li>
...
<li>Notably, this makes jQuery's <code>show()</code> and <code>hide()</code> methods now work correctly; see <a href="https://github.com/tmpvar/jsdom/issues/994">#994</a>.</li>
</ul>
</li>
...
<ul>
<li>Implemented the <a href="https://dom.spec.whatwg.org/#nondocumenttypechildnode"><code>NonDocumentTypeChildNode</code></a> mixin. Practically, this means adding <code>nextElementSibling</code> and <code>previousElementSibling</code> to <code>Element</code> and the various types of <code>CharacterData</code>. (brandon-bethke-neudesic)</li>
...
<li>Some weirdnesses around the <code>style</code> attribute were fixed along the way; see e.g. <a href="https://github.com/tmpvar/jsdom/issues/1109">#1109</a>.</li>
...
<h2>5.3.0</h2>
<ul>
<li>Added a <code>virtualConsole</code> option to the document creation methods, along with the <code>jsdom.createVirtualConsole</code> factory. (See <a href="https://github.com/tmpvar/jsdom/blob/dbf88666d1152576237ed1c741263f5516bb4005/README.md#capturing-console-output">examples in the readme</a>.) With this option you can install a virtual console before the document is even created, thus allowing you to catch any virtual console events that occur during initialization. (jeffcarp)</li>
</ul>
<h2>5.2.0</h2>
<ul>
<li>Implemented much of the <a href="https://dom.spec.whatwg.org/#interface-parentnode"><code>ParentNode</code></a> mixin (Joris-van-der-Wel):<ul>
...
<h2>5.0.0</h2>
<p>This release overhauls how cookies are handled in jsdom to be less fiddly and more like-a-browser. The work for this was done by <a href="https://github.com/inikulin"></a>, who is also our beloved parse5 maintainer.</p>
...
<li>Within a given cookie jar, cookie access is now automatically handled on a domain basis, as the browser does, with the domain calculated from the document's <a class="el" href="namespace_u_r_l.html">URL</a> (supplied as <code>options.url</code> when creating a document). This supplants the former <code>options.document.cookieDomain</code>.</li>
</ul>
...
<p>Finally, it's worth noting that we now delegate our cookie handling in general to the <a href="https://www.npmjs.com/package/tough-cookie">tough-cookie</a> package, which should hopefully mean that it now captures many of the behaviors that were previously missing (for example <a href="https://github.com/tmpvar/jsdom/issues/1027">#1027</a>).  is working on <a href="https://github.com/goinstant/tough-cookie/pull/30">a large pull request to fix tough-cookie to be more spec compliant</a>, which should automatically be picked up by jsdom installs once it is merged.</p>
<h2>4.5.1</h2>
<ul>
...
<h2>4.4.0</h2>
<ul>
<li>All resources are now loaded with the <a href="https://www.npmjs.com/package/request">request</a> package, which means that e.g. GZIPped resources will be properly uncompressed, redirects will be followed, and more. This was previously the case only for URLs passed directly to <code>jsdom.env</code>, and not for sub-resources inside the resulting page. (ssesha)</li>
</ul>
<h2>4.3.0</h2>
<ul>
...
<li>Fixed the <a class="el" href="namespace_u_r_l.html">URL</a> resolution algorithm to handle <code>about:blank</code> properly on all systems (previously it only worked on Windows). This is especially important since as of 3.0.0 the default <a class="el" href="namespace_u_r_l.html">URL</a> is <code>about:blank</code>.</li>
...
<li>Fixed a couple small issues while browserifying, mainly around <code>jsdom.env</code>. However, while doing so discovered that <code>&lt;script&gt;</code>s in general don't work too well in a browserified jsdom; see <a href="https://github.com/tmpvar/jsdom/issues/1023">#1023</a>.</li>
</ul>
<h2>3.1.0</h2>
<ul>
...
<p>3.0.x will be the last release of jsdom to support Node.js. All future releases (starting with 4.0.0) will require <a href="https://iojs.org/">io.js</a>, whose <a href="https://github.com/iojs/io.js/blob/v1.x/CHANGELOG.md#vm">new <code>vm</code> module</a> will allow us to remove our contextify native-module dependency. (Given that I submitted the relevant patch to joyent/node <a href="https://github.com/joyent/node/commit/7afdba6e0bc3b69c2bf5fdbd59f938ac8f7a64c5">1.5 years ago</a>, I'm very excited that we can finally use it!)</p>
<ul>
<li>By default documents now use <code>about:blank</code> as their <a class="el" href="namespace_u_r_l.html">URL</a>, instead of trying to infer some type of file <a class="el" href="namespace_u_r_l.html">URL</a> from the call site (in Node.js) or using <code>location.href</code> (in browsers).</li>
<li>Introduced a new "virtual console" abstraction for capturing console output from inside the page. <a href="https://github.com/tmpvar/jsdom#capturing-console-output">See the readme for more information.</a> Note that <code>console.error</code> will no longer contribute to the (non-standard, and likely dying in the future) <code>window.errors</code> array. (jeffcarp)</li>
...
<h2>1.5.0</h2>
<ul>
<li>Add: missing <code>window.console</code> methods, viz. <code>assert</code>, <code>clear</code>, <code>count</code>, <code>debug</code>, <code>group</code>, <code>groupCollapse</code>, <code>groupEnd</code>, <code>table</code>, <code>time</code>, <code>timeEnd</code>, and <code>trace</code>. All except <code>assert</code> do nothing for now, but see <a href="https://github.com/tmpvar/jsdom/issues/979">#979</a> for future plans. (jeffcarp)</li>
...
<h2>1.3.2</h2>
<ul>
<li>Fix: check if <code>module.parent</code> exists before using it to construct a document's initial <a class="el" href="namespace_u_r_l.html">URL</a>. Apparently some testing frameworks like Jest do not correctly emulate the module environment; this compensates. (SegFaultx64)</li>
</ul>
<h2>1.3.1</h2>
<ul>
...
<h2>1.0.2</h2>
<ul>
<li>Fix: temporarily pin <code>cssstyle</code> dependency to at most 0.2.18 until <a href="https://github.com/chad3814/CSSStyleDeclaration/issues/20">chad3814/CSSStyleDeclaration#20</a> is fixed.</li>
...
<li>Fix: using <code>jsom.env</code> in a browser environment now correctly defaults <code>options.url</code> to <code>location.href</code> instead of trying to infer a reasonable <code>fil://</code> <a class="el" href="namespace_u_r_l.html">URL</a> using techniques that fail in the browser. (rattrayalex)</li>
</ul>
<h2>1.0.1</h2>
<ul>
...
<h2>1.0.0-pre.1</h2>
<p>This is a prerelease of jsdom's first major version. It incorporates several great additions, as well as a general cleanup of the API surface, which make it more backward-incompatible than usual. Starting with the 1.0.0 release, we will be following semantic versioning, so that you can depend on stability within major version ranges. But we still have <a href="https://github.com/tmpvar/jsdom/issues?q=is%3Aopen+is%3Aissue+milestone%3A1.0">a few more issues</a> before we can get there, so I don't want to do 1.0.0 quite yet.</p>
<p>This release owes a special thanks to <a href="https://github.com/Sebmaster"></a>, for his amazing work taking on some of the hardest problems in jsdom and solving them with gusto.</p>
<h3>Major changes</h3>
<ul>
...
<h3>Changed jsdom APIs</h3>
<ul>
<li><code>jsdom.jsdom</code> no longer takes a level as its second argument.</li>
<li><code>jsdom.jQueryify</code> now requires a jQuery <a class="el" href="namespace_u_r_l.html">URL</a>, since <a href="http://blog.jquery.com/2014/07/03/dont-use-jquery-latest-js/">always picking the latest was a bad idea</a>.</li>
</ul>
<h3>Removed non-standard DOM APIs</h3>
<ul>
...
<li>Fix: attributes that are reflected as properties should be &lsquo;&rsquo;'<code>when not present, instead of</code>null<code>. (Note that</code>getAttribute<code>still returns</code>null<code>for them). (thejameskyle)</code></li>
<li><code>Fix:</code>textContent<code>now works for nodes that do not have children, like text nodes for example. (hayes)</code></li>
<li><code>Fix:</code>jsdom.jQueryify` was using the wrong <a class="el" href="namespace_u_r_l.html">URL</a> for jQuery by default. (lukasbuenger)</li>
</ul>
<h2>0.11.0</h2>
<ul>
...
<h2>0.10.6</h2>
<ul>
<li>Add: remaining <a class="el" href="namespace_u_r_l.html">URL</a> properties to <code>window.location</code> and <code>HTMLAnchorElement</code>.</li>
...
<li>Fix: set <code>window.location.href</code> correctly when using <code>jsdom.env</code> to construct a window from a <a class="el" href="namespace_u_r_l.html">URL</a>, when that <a class="el" href="namespace_u_r_l.html">URL</a> causes a redirect. (fegs)</li>
...
<h2>0.6.2</h2>
<ul>
<li>Fix: <a class="el" href="namespace_u_r_l.html">URL</a> resolution to be amazing and extremely browser-compatible, including the interplay between the document's original <a class="el" href="namespace_u_r_l.html">URL</a>, any <code>&lt;base&gt;</code> tags that were set, and any relative <code>href</code>s. This impacts many parts of jsdom having to do with external resources or accurate <code>href</code> and <code>src</code> attributes. (deitch)</li>
...
<li>Add: support for running the tests using 's <a href="https://npmjs.org/package/html5">html5</a> parser, as a prelude toward maybe eventually making this the default and fixing various parsing bugs.</li>
</ul>
<h2>0.3.1 (hotfix)</h2>
<ul>
...
<h2>0.2.19</h2>
<ul>
<li>Fix: <a class="el" href="namespace_u_r_l.html">URL</a> resolution was broken on pages that included <code>href</code>-less <code>&lt;base&gt;</code> tags.</li>
...
<li>Fix: many more tests passing, especially related to <a href="file:///">file:///</a> URLs on Windows. Tests can now be run with <code>npm test</code>.</li>
</ul>
<h2>0.2.15</h2>
<ul>
...
<li>Add: documentation now includes &lsquo;jsdom.level(x, 'feature&rsquo;)<code></code></li>
<li><code>Fix: make</code>toArray<code>and</code>item<code>on</code>NodeList<code>objects non-enumerable properties</code></li>
<li><code>Add: a reference to</code>window.close` in the readme</li>
...
<li>Fix: When &lsquo;ProcessExternalResources['script&rsquo;]` is disabled, do <em>not</em> run inline event handlers. #355</li>
...
<li>Add: support for inline event handlers (ie: &lsquo;&lt;div onclick='some.horrible.string()&rsquo;&gt;`) (Brian McDaniel)</li>
...
<h2>0.2.3</h2>
<ul>
<li>Fix: segfault due to window being garbage collected prematurely NOTE: you must manually close the window to free memory (window.close())</li>
</ul>
<h2>0.2.2</h2>
<ul>
