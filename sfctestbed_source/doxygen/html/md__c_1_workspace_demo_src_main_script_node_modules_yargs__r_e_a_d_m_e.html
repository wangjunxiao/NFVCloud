...
<div class="fragment"><div class="line">yargs</div><div class="line">  .command(&#39;get&#39;, &#39;make a get HTTP request&#39;, {</div><div class="line">    url: {</div><div class="line">      alias: &#39;u&#39;,</div><div class="line">      default: &#39;http://yargs.js.org/&#39;</div><div class="line">    }</div><div class="line">  })</div><div class="line">  .help()</div><div class="line">  .argv</div></div><!-- fragment --><p>Note that commands will not automatically inherit configuration <em>or</em> options of their parent context. This means you'll have to re-apply configuration if necessary, and make options global manually using the <a href="#global">global</a> method.</p>
<p>Additionally, the <a href="#help"><code>help</code></a> and <a href="#version"><code>version</code></a> options (if used) <b>always</b> apply globally, just like the <a href="#wrap"><code>.wrap()</code></a> configuration.</p>
...
<div class="fragment"><div class="line">yargs</div><div class="line">  .command(</div><div class="line">    &#39;get&#39;,</div><div class="line">    &#39;make a get HTTP request&#39;,</div><div class="line">    function (yargs) {</div><div class="line">      return yargs.option(&#39;u&#39;, {</div><div class="line">        alias: &#39;url&#39;,</div><div class="line">        describe: &#39;the URL to make an HTTP request to&#39;</div><div class="line">      })</div><div class="line">    },</div><div class="line">    function (argv) {</div><div class="line">      console.log(argv.url)</div><div class="line">    }</div><div class="line">  )</div><div class="line">  .help()</div><div class="line">  .argv</div></div><!-- fragment --><h3>Positional Arguments</h3>
...
<div class="fragment"><div class="line">#!/usr/bin/env node</div><div class="line">require(&#39;yargs&#39;)</div><div class="line">  .command([&#39;start [app]&#39;, &#39;run&#39;, &#39;up&#39;], &#39;Start up an app&#39;, {}, (argv) =&gt; {</div><div class="line">    console.log(&#39;starting up the&#39;, argv.app || &#39;default&#39;, &#39;app&#39;)</div><div class="line">  })</div><div class="line">  .command({</div><div class="line">    command: &#39;configure &lt;key&gt; [value]&#39;,</div><div class="line">    aliases: [&#39;config&#39;, &#39;cfg&#39;],</div><div class="line">    desc: &#39;Set a config variable&#39;,</div><div class="line">    builder: (yargs) =&gt; yargs.default(&#39;value&#39;, &#39;true&#39;),</div><div class="line">    handler: (argv) =&gt; {</div><div class="line">      console.log(`setting ${argv.key} to ${argv.value}`)</div><div class="line">    }</div><div class="line">  })</div><div class="line">  .demandCommand(1)</div><div class="line">  .help()</div><div class="line">  .wrap(72)</div><div class="line">  .argv</div></div><!-- fragment --><div class="fragment"><div class="line">$ ./svc.js help</div><div class="line">Commands:</div><div class="line">  start [app]              Start up an app            [aliases: run, up]</div><div class="line">  configure &lt;key&gt; [value]  Set a config variable  [aliases: config, cfg]</div><div class="line"></div><div class="line">Options:</div><div class="line">  --help  Show help                                            [boolean]</div><div class="line"></div><div class="line">$ ./svc.js cfg concurrency 4</div><div class="line">setting concurrency to 4</div><div class="line"></div><div class="line">$ ./svc.js run web</div><div class="line">starting up the web app</div></div><!-- fragment --><h3>Providing a Command Module</h3>
...
<div class="fragment"><div class="line">#!/usr/bin/env node</div><div class="line">require(&#39;yargs&#39;)</div><div class="line">  .commandDir(&#39;cmds&#39;)</div><div class="line">  .demandCommand(1)</div><div class="line">  .help()</div><div class="line">  .argv</div></div><!-- fragment --><p>cmds/init.js:</p>
...
<div class="fragment"><div class="line">var argv = require(&#39;yargs&#39;)</div><div class="line">  .config({foo: 1, bar: 2})</div><div class="line">  .argv</div><div class="line">console.log(argv)</div></div><!-- fragment --><div class="fragment"><div class="line">$ node test.js</div><div class="line">{ _: [],</div><div class="line">  foo: 1,</div><div class="line">  bar: 2,</div><div class="line">  &#39;$0&#39;: &#39;test.js&#39; }</div></div><!-- fragment --><h2><a class="anchor" id="conflicts"></a>.conflicts(x, y) </h2>
...
<h2><a class="anchor" id="global"></a>.global(globals) </h2>
<p>Indicate that an option (or group of options) should not be reset when a command is executed, as an example:</p>
<div class="fragment"><div class="line">var argv = require(&#39;yargs&#39;)</div><div class="line">  .option(&#39;a&#39;, {</div><div class="line">    alias: &#39;all&#39;,</div><div class="line">    default: true</div><div class="line">  })</div><div class="line">  .option(&#39;n&#39;, {</div><div class="line">    alias: &#39;none&#39;,</div><div class="line">    default: true</div><div class="line">  })</div><div class="line">  .command(&#39;foo&#39;, &#39;foo command&#39;, function (yargs) {</div><div class="line">    return yargs.option(&#39;b&#39;, {</div><div class="line">      alias: &#39;bar&#39;</div><div class="line">    })</div><div class="line">  })</div><div class="line">  .help(&#39;help&#39;)</div><div class="line">  .global(&#39;a&#39;)</div><div class="line">  .argv</div></div><!-- fragment --><p>If the <code>foo</code> command is executed the <code>all</code> option will remain, but the <code>none</code> option will have been eliminated.</p>
...
<div class="fragment"><div class="line">var argv = require(&#39;yargs&#39;)</div><div class="line">  .usage(&#39;./$0 - follow ye instructions true&#39;)</div><div class="line">  .option(&#39;option&#39;, {</div><div class="line">    alias: &#39;o&#39;,</div><div class="line">    describe: &quot;&#39;tis a mighty fine option&quot;,</div><div class="line">    demand: true</div><div class="line">  })</div><div class="line">  .command(&#39;run&#39;, &quot;Arrr, ya best be knowin&#39; what yer doin&#39;&quot;)</div><div class="line">  .example(&#39;$0 run foo&#39;, &quot;shiver me timbers, here&#39;s an example for ye&quot;)</div><div class="line">  .help(&#39;help&#39;)</div><div class="line">  .wrap(70)</div><div class="line">  .locale(&#39;pirate&#39;)</div><div class="line">  .argv</div></div><!-- fragment --><hr/>
