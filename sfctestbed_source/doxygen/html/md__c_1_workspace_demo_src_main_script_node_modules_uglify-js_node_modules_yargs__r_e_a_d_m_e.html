...
<p><a href="https://travis-ci.org/bcoe/yargs"></a> <a href="https://gemnasium.com/bcoe/yargs"></a> <a href="https://coveralls.io/r/bcoe/yargs?branch="></a> <a href="https://www.npmjs.com/package/yargs"></a></p>
...
<img src="http://i.imgur.com/4WFGVJ9.png" alt="Joe was one optimistic pirate."/>
</div>
...
<p>bool.js:</p>
<div class="fragment"><div class="line">#!/usr/bin/env node</div><div class="line">var util = require(&#39;util&#39;);</div><div class="line">var argv = require(&#39;yargs&#39;).argv;</div><div class="line"></div><div class="line">if (argv.s) {</div><div class="line">    util.print(argv.fr ? &#39;Le perroquet dit: &#39; : &#39;The parrot says: &#39;);</div><div class="line">}</div><div class="line">console.log(</div><div class="line">    (argv.fr ? &#39;couac&#39; : &#39;squawk&#39;) + (argv.p ? &#39;!&#39; : &#39;&#39;)</div><div class="line">);</div></div><!-- fragment --><hr/>
...
<p>count.js</p>
<div class="fragment"><div class="line">#!/usr/bin/env node</div><div class="line">var argv = require(&#39;yargs&#39;)</div><div class="line">    .count(&#39;verbose&#39;)</div><div class="line">    .alias(&#39;v&#39;, &#39;verbose&#39;)</div><div class="line">    .argv;</div><div class="line"></div><div class="line">VERBOSE_LEVEL = argv.verbose;</div><div class="line"></div><div class="line">function WARN()  { VERBOSE_LEVEL &gt;= 0 &amp;&amp; console.log.apply(console, arguments); }</div><div class="line">function INFO()  { VERBOSE_LEVEL &gt;= 1 &amp;&amp; console.log.apply(console, arguments); }</div><div class="line">function DEBUG() { VERBOSE_LEVEL &gt;= 2 &amp;&amp; console.log.apply(console, arguments); }</div><div class="line"></div><div class="line">WARN(&quot;Showing only important stuff&quot;);</div><div class="line">INFO(&quot;Showing semi-mportant stuff too&quot;);</div><div class="line">DEBUG(&quot;Extra chatty mode&quot;);</div></div><!-- fragment --><hr/>
...
<p>area.js:</p>
<div class="fragment"><div class="line">#!/usr/bin/env node</div><div class="line">var argv = require(&#39;yargs&#39;)</div><div class="line">    .usage(&#39;Usage: $0 -w [num] -yh[num]&#39;)</div><div class="line">    .demand([&#39;w&#39;,&#39;h&#39;])</div><div class="line">    .argv;</div><div class="line"></div><div class="line">console.log(&quot;The area is:&quot;, argv.w * argv.h);</div></div><!-- fragment --><hr/>
...
</pre><h2>After yer demands have been met, demand more! Ask for non-hypenated arguments! </h2>
<p>demand_count.js:</p>
<div class="fragment"><div class="line">#!/usr/bin/env node</div><div class="line">var argv = require(&#39;yargs&#39;)</div><div class="line">    .demand(2)</div><div class="line">    .argv;</div><div class="line">console.dir(argv)</div></div><!-- fragment --><hr/>
...
<p>line_count.js</p>
<div class="fragment"><div class="line">#!/usr/bin/env node</div><div class="line">var argv = require(&#39;yargs&#39;)</div><div class="line">    .usage(&#39;Usage: $0 &lt;command&gt; [options]&#39;)</div><div class="line">    .command(&#39;count&#39;, &#39;Count the lines in a file&#39;)</div><div class="line">    .demand(1)</div><div class="line">    .example(&#39;$0 count -f foo.js&#39;, &#39;count the lines in the given file&#39;)</div><div class="line">    .demand(&#39;f&#39;)</div><div class="line">    .alias(&#39;f&#39;, &#39;file&#39;)</div><div class="line">    .nargs(&#39;f&#39;, 1)</div><div class="line">    .describe(&#39;f&#39;, &#39;Load a file&#39;)</div><div class="line">    .help(&#39;h&#39;)</div><div class="line">    .alias(&#39;h&#39;, &#39;help&#39;)</div><div class="line">    .epilog(&#39;copyright 2015&#39;)</div><div class="line">    .argv;</div><div class="line"></div><div class="line">var fs = require(&#39;fs&#39;);</div><div class="line">var s = fs.createReadStream(argv.file);</div><div class="line"></div><div class="line">var lines = 0;</div><div class="line">s.on(&#39;data&#39;, function (buf) {</div><div class="line">    lines += buf.toString().match(/\n/g).length;</div><div class="line">});</div><div class="line"></div><div class="line">s.on(&#39;end&#39;, function () {</div><div class="line">    console.log(lines);</div><div class="line">});</div></div><!-- fragment --><hr/>
<p> $ node line_count.js count Usage: node test.js &lt;command&gt; [options]</p>
<p>Commands: count Count the lines in a file</p>
<p>Options: -f, &ndash;file Load a file [required] -h, &ndash;help Show help</p>
<p>Examples: node test.js count -f foo.js count the lines in the given file</p>
<p>copyright 2015</p>
<p>Missing required arguments: f</p>
<p>$ node line_count.js count &ndash;file line_count.js 20</p>
<p>$ node line_count.js count -f line_count.js 20</p>
<h1>methods </h1>
<p>By itself,</p>
<p>```&lsquo;javascript require('yargs&rsquo;).argv `````</p>
...
<div class="fragment"><div class="line">require(&#39;yargs&#39;)([ &#39;-x&#39;, &#39;1&#39;, &#39;-y&#39;, &#39;2&#39; ]).argv</div></div><!-- fragment --><p>or use .parse() to do the same thing:</p>
...
<h2>.default(key, value, [description]) </h2>
...
<div class="fragment"><div class="line">.default(&#39;timeout&#39;, 60000, &#39;(one-minute)&#39;);</div></div><!-- fragment --><h2>.demand(key, [msg | boolean]) </h2>
...
<p>For example:</p>
<div class="fragment"><div class="line">var argv = require(&#39;yargs&#39;)</div><div class="line">    .option(&#39;f&#39;, {</div><div class="line">        alias : &#39;file&#39;,</div><div class="line">        demand: true,</div><div class="line">        default: &#39;/etc/passwd&#39;,</div><div class="line">        describe: &#39;x marks the spot&#39;,</div><div class="line">        type: &#39;string&#39;</div><div class="line">    })</div><div class="line">    .argv</div><div class="line">;</div></div><!-- fragment --><p>is the same as</p>
<div class="fragment"><div class="line">var argv = require(&#39;yargs&#39;)</div><div class="line">    .alias(&#39;f&#39;, &#39;file&#39;)</div><div class="line">    .default(&#39;f&#39;, &#39;/etc/passwd&#39;)</div><div class="line">    .argv</div><div class="line">;</div></div><!-- fragment --><p>Optionally <code>.options()</code> can take an object that maps keys to <code>opt</code> parameters.</p>
<div class="fragment"><div class="line">var argv = require(&#39;yargs&#39;)</div><div class="line">    .options({</div><div class="line">      &#39;f&#39;: {</div><div class="line">        alias: &#39;file&#39;,</div><div class="line">        demand: true,</div><div class="line">        default: &#39;/etc/passwd&#39;,</div><div class="line">        describe: &#39;x marks the spot&#39;,</div><div class="line">        type: &#39;string&#39;</div><div class="line">      }</div><div class="line">    })</div><div class="line">    .argv</div><div class="line">;</div></div><!-- fragment --><h2>.usage(message, opts) </h2>
...
<div class="fragment"><div class="line">var argv = require(&#39;yargs&#39;)</div><div class="line">  .usage(&#39;npm &lt;command&gt;&#39;)</div><div class="line">  .command(&#39;install&#39;, &#39;tis a mighty fine package to install&#39;)</div><div class="line">  .command(&#39;publish&#39;, &#39;shiver me timbers, should you be sharing all that&#39;, function (yargs) {</div><div class="line">    argv = yargs.option(&#39;f&#39;, {</div><div class="line">      alias: &#39;force&#39;,</div><div class="line">      description: &#39;yar, it usually be a bad idea&#39;</div><div class="line">    })</div><div class="line">    .help(&#39;help&#39;)</div><div class="line">    .argv</div><div class="line">  })</div><div class="line">  .help(&#39;help&#39;)</div><div class="line">  .argv;</div></div><!-- fragment --><h2>.example(cmd, desc) </h2>
...
<div class="fragment"><div class="line">var argv = require(&#39;yargs&#39;)</div><div class="line">  .epilogue(&#39;for more information, find our manual at http://example.com&#39;);</div></div><!-- fragment --><h2>.check(fn) </h2>
...
<h2>.array(key) </h2>
<p>Tell the parser to interpret <code>key</code> as an array. If &lsquo;.array('foo&rsquo;)<code>is set, </code>&ndash;foo foo bar<code>will be parsed as</code>['foo', 'bar']<code>rather than as</code>'bar'`.</p>
<h2>.nargs(key, count) </h2>
...
<p>Example:</p>
<div class="fragment"><div class="line">var yargs = require(&quot;yargs&quot;)</div><div class="line">       .usage(&quot;$0 -operand1 number -operand2 number -operation [add|subtract]&quot;);</div><div class="line">console.log(yargs.help());</div></div><!-- fragment --><p>Later on, <code>argv</code> can be retrived with <code>yargs.argv</code></p>
<h2>.version(version, [option], [description]) </h2>
...
<div class="fragment"><div class="line">var argv = require(&#39;yargs&#39;)</div><div class="line">  .version(function() {</div><div class="line">    return require(&#39;../package&#39;).version;</div><div class="line">  })</div><div class="line">  .argv;</div></div><!-- fragment --><h2>.showHelpOnFail(enable, [message]) </h2>
...
<p>line_count.js</p>
<div class="fragment"><div class="line">#!/usr/bin/env node</div><div class="line">var argv = require(&#39;yargs&#39;)</div><div class="line">    .usage(&#39;Count the lines in a file.\nUsage: $0&#39;)</div><div class="line">    .demand(&#39;f&#39;)</div><div class="line">    .alias(&#39;f&#39;, &#39;file&#39;)</div><div class="line">    .describe(&#39;f&#39;, &#39;Load a file&#39;)</div><div class="line">    .showHelpOnFail(false, &quot;Specify --help for available options&quot;)</div><div class="line">    .argv;</div><div class="line"></div><div class="line">// etc.</div></div><!-- fragment --><hr/>
 <pre class="fragment">$ node line_count.js --file
Missing argument value: f

Specify --help for available options
</pre><h2>.showHelp(consoleLevel='error') </h2>
...
<p>Example:</p>
<div class="fragment"><div class="line">var yargs = require(&quot;yargs&quot;)</div><div class="line">       .usage(&quot;$0 -operand1 number -operand2 number -operation [add|subtract]&quot;);</div><div class="line">yargs.showHelp();</div></div><!-- fragment --><p>Or, to print the usage data to <code>stdout</code> instead, you can specify the use of <code>console.log</code>:</p>
<div class="fragment"><div class="line">yargs.showHelp(&quot;log&quot;);</div></div><!-- fragment --><p>Later on, <code>argv</code> can be retrived with <code>yargs.argv</code></p>
...
<div class="fragment"><div class="line">var argv = require(&#39;yargs&#39;)</div><div class="line">  .completion(&#39;completion&#39;, function(current, argv) {</div><div class="line">    // &#39;current&#39; is the current command being completed.</div><div class="line">    // &#39;argv&#39; is the parsed arguments so far.</div><div class="line">    // simply return an array of completions.</div><div class="line">    return [</div><div class="line">      &#39;foo&#39;,</div><div class="line">      &#39;bar&#39;</div><div class="line">    ];</div><div class="line">  })</div><div class="line">  .argv;</div></div><!-- fragment --><p>But wait, there's more! you can provide asynchronous completions.</p>
<div class="fragment"><div class="line">var argv = require(&#39;yargs&#39;)</div><div class="line">  .completion(&#39;completion&#39;, function(current, argv, done) {</div><div class="line">    setTimeout(function() {</div><div class="line">      done([</div><div class="line">        &#39;apple&#39;,</div><div class="line">        &#39;banana&#39;</div><div class="line">      ]);</div><div class="line">    }, 500);</div><div class="line">  })</div><div class="line">  .argv;</div></div><!-- fragment --><h2>.showCompletionScript() </h2>
...
<p>With <a href="http://github.com/isaacs/npm">npm</a>, just do: </p><pre class="fragment">npm install yargs
</pre><p>or clone this project on github: </p><pre class="fragment">git clone http://github.com/bcoe/yargs.git
</pre><p>To run the tests with npm, just do: </p><pre class="fragment">npm test
</pre><h1>inspired by </h1>
