\href{https://travis-ci.org/A11yance/axobject-query}{\tt }

{\bfseries N\+O\+T\+I\+CE\+: The A\+PI for A\+X\+Object Query is very much under development until a major version release. Please be aware that data structures might change in minor version releases before 1.\+0.\+0 is released.}
...
The project attempts to map the A\+X\+Object concepts to the \href{https://www.w3.org/TR/wai-aria-1.1/#roles}{\tt W\+A\+I-\/\+A\+R\+IA 1.\+1 Roles Model} so that a complete representation of the semantic H\+T\+ML layer, as it is exposed assistive technology, can be obtained.
