...
Move cursor up a specific amount of rows. Default is {\ttfamily 1}.

\subsubsection*{cursor\+Down(count)}

Move cursor down a specific amount of rows. Default is {\ttfamily 1}.

\subsubsection*{cursor\+Forward(count)}

Move cursor forward a specific amount of rows. Default is {\ttfamily 1}.

\subsubsection*{cursor\+Backward(count)}

Move cursor backward a specific amount of rows. Default is {\ttfamily 1}.
...
{\itshape Currently only supported on i\+Term $>$=2.\+9.}
