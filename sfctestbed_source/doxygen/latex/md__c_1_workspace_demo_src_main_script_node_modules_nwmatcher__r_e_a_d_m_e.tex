A fast C\+SS selector engine and matcher.
...
Returns a reference to the first element matching {\ttfamily selector}, starting at {\ttfamily context}.
...
\paragraph*{{\ttfamily by\+Name( name, from )}}
