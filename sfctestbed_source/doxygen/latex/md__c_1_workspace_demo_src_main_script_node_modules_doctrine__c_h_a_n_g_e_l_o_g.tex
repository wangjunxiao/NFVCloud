...
\item 8d9b3c7 Upgrade\+: Upgrade esutils to v2.\+0.\+2 (fixes \#170) (\#171) (Emeegeemee)
\end{DoxyItemize}
...
\item e2cbbc5 Update\+: Bump isarray to v1.\+0.\+0 (Shinnosuke Watanabe)
...
\item New\+: support name expression for  tag (fixes \#143) (Tim Schaub)
\item Build\+: Update E\+S\+Lint settings (Nicholas C. Zakas)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item Fix\+: Line numbers for some tags (fixes \#138) Fixing issue where input was not consumed via advance() but was skipped when parsing tags resulting in sometimes incorrect reported line\+Number. (T\+E\+H\+EK)
...
\begin{DoxyItemize}
\item Docs\+: Update R\+E\+A\+D\+ME with new info (fixes \#127) (Nicholas C. Zakas)
