...
\subsection*{v4.\+0.\+10 -\/ May 21st, 2017}


\begin{DoxyItemize}
\item Fix regression in 4.\+0.\+9\+: Replace \char`\"{}\+Object.\+assign\char`\"{} (not support in IE) by \char`\"{}util/extend\char`\"{} -\/ 0e953d1
\end{DoxyItemize}

\href{https://github.com/nknapp/handlebars.js/compare/v4.0.9...v4.0.10}{\tt Commits}

\subsection*{v4.\+0.\+9 -\/ May 21st, 2017}
...
\subsection*{v4.\+0.\+8 -\/ May 2nd, 2017}
...
\subsection*{v4.\+0.\+7 -\/ April 29th, 2017}
...
\subsection*{v4.\+0.\+6 -\/ November 12th, 2016}
...
\subsection*{v4.\+0.\+5 -\/ November 19th, 2015}
...
\subsection*{v4.\+0.\+4 -\/ October 29th, 2015}
...
\subsection*{v4.\+0.\+3 -\/ September 23rd, 2015}
...
\item \href{https://github.com/wycats/handlebars.js/pull/1090}{\tt \#1090} -\/ grammar fixes in 4.\+0.\+0 release notes (\href{https://api.github.com/users/nikolas}{\tt })
\end{DoxyItemize}

Compatibility notes\+:
\begin{DoxyItemize}
\item {\ttfamily each} iteration with {\ttfamily undefined} values has been restored to the 3.\+0 behaviors. Helper calls with undefined context values will now execute against an arbitrary empty object to avoid executing against global object in non-\/strict mode.
...
\href{https://github.com/wycats/handlebars.js/compare/v4.0.2...v4.0.3}{\tt Commits}

\subsection*{v4.\+0.\+2 -\/ September 4th, 2015}
...
\subsection*{v4.\+0.\+1 -\/ September 2nd, 2015}
...
\subsection*{v4.\+0.\+0 -\/ September 1st, 2015}
...
\item The runtime version has been increased. Precompiled templates will need to use runtime of at least 4.\+0.\+0.
\end{DoxyItemize}

\href{https://github.com/wycats/handlebars.js/compare/v3.0.3...v4.0.0}{\tt Commits}

\subsection*{v3.\+0.\+3 -\/ April 28th, 2015}
...
\href{https://github.com/wycats/handlebars.js/compare/v3.0.2...v3.0.3}{\tt Commits}

\subsection*{v3.\+0.\+2 -\/ April 20th, 2015}
...
\subsection*{v3.\+0.\+1 -\/ March 24th, 2015}
...
\item \href{https://github.com/wycats/handlebars.js/issues/966}{\tt \#966} -\/ \char`\"{}handlebars -\/-\/version\char`\"{} does not work with v3.\+0.\+0 (\href{https://api.github.com/users/abloomston}{\tt })
...
\subsection*{v3.\+0.\+0 -\/ February 10th, 2015}
...
\subsection*{v2.\+0.\+0 -\/ September 1st, 2014}


\begin{DoxyItemize}
\item Update jsfiddle to 2.\+0.\+0-\/beta.\+1 -\/ 0670f65
\item Add contrib note regarding handlebarsjs.\+com docs -\/ 4d17e3c
\item Play nice with gemspec version numbers -\/ 64d5481
\end{DoxyItemize}

\href{https://github.com/wycats/handlebars.js/compare/v2.0.0-beta.1...v2.0.0}{\tt Commits}

\subsection*{v2.\+0.\+0-\/beta.\+1 -\/ August 26th, 2014}
...
\item Runtime compatibility breaks in both directions. Ensure that both compiler and client are upgraded to 2.\+0.\+0-\/beta.\+1 or higher at the same time.
\begin{DoxyItemize}
...
\href{https://github.com/wycats/handlebars.js/compare/v2.0.0-alpha.4...v2.0.0-beta.1}{\tt Commits}

\subsection*{v2.\+0.\+0-\/alpha.\+4 -\/ May 19th, 2014}
...
\subsection*{v2.\+0.\+0-\/alpha.\+3 -\/ May 19th, 2014}
...
\subsection*{v2.\+0.\+0-\/alpha.\+2 -\/ March 6th, 2014}
...
\subsection*{v2.\+0.\+0-\/alpha.\+1 -\/ February 10th, 2014}
...
\item \href{https://github.com/wycats/handlebars.js/issues/658}{\tt \#658} -\/ Depthed helpers do not work after an upgrade from 1.\+0.\+0 (\href{https://api.github.com/users/xibxor}{\tt })
...
\item \href{https://github.com/wycats/handlebars.js/issues/705}{\tt \#705} -\/ 1.\+3.\+0 can not be wrapped in an I\+I\+FE (\href{https://api.github.com/users/craigteegarden}{\tt })
...
\href{https://github.com/wycats/handlebars.js/compare/v1.3.0...v2.0.0-alpha.1}{\tt Commits}

\subsection*{v1.\+3.\+0 -\/ January 1st, 2014}
...
\subsection*{v1.\+2.\+1 -\/ December 26th, 2013}
...
\item \href{https://github.com/wycats/handlebars.js/pull/686}{\tt \#686} -\/ Falsy A\+MD module names in version 1.\+2.\+0 (\href{https://api.github.com/users/kpdecker}{\tt })
\end{DoxyItemize}

\href{https://github.com/wycats/handlebars.js/compare/v1.2.0...v1.2.1}{\tt Commits}

\subsection*{v1.\+2.\+0 -\/ December 23rd, 2013}
...
\item \href{https://github.com/wycats/handlebars.js/issues/662}{\tt \#662} -\/ handlebars-\/source 1.\+1.\+2 is missing from Ruby\+Gems.
...
\subsection*{v1.\+1.\+2 -\/ November 5th, 2013}


\begin{DoxyItemize}
\item \href{https://github.com/wycats/handlebars.js/issues/645}{\tt \#645} -\/ 1.\+1.\+1 fails under I\+E8 (\href{https://api.github.com/users/kpdecker}{\tt })
\item \href{https://github.com/wycats/handlebars.js/issues/644}{\tt \#644} -\/ Using precompiled templates (A\+MD mode) with handlebars.\+runtime 1.\+1.\+1 (\href{https://api.github.com/users/fddima}{\tt })
\item Add simple binary utility tests -\/ 96a45a4
\item Fix empty string compilation -\/ eea708a
\end{DoxyItemize}

\href{https://github.com/wycats/handlebars.js/compare/v1.1.1...v1.1.2}{\tt Commits}

\subsection*{v1.\+1.\+1 -\/ November 4th, 2013}


\begin{DoxyItemize}
\item \href{https://github.com/wycats/handlebars.js/issues/642}{\tt \#642} -\/ handlebars 1.\+1.\+0 are broken with nodejs
\item Fix release notes link -\/ 17ba258
\end{DoxyItemize}

\href{https://github.com/wycats/handlebars.js/compare/v1.1.0...v1.1.1}{\tt Commits}

\subsection*{v1.\+1.\+0 -\/ November 3rd, 2013}
...
\item Globals\+: The {\ttfamily handlebars.\+js} and {\ttfamily handlebars.\+runtime.\+js} files should behave in the same manner as the v1.\+0.\+12 / 1.\+0.\+0 release.
\end{DoxyItemize}
...
\subsection*{v1.\+0.\+12 / 1.\+0.\+0 -\/ May 31 2013}
...
\item The compiler version has changed. Precompiled templates with 1.\+0.\+12 or higher must use the 1.\+0.\+0 or higher runtime.
\end{DoxyItemize}

\href{https://github.com/wycats/handlebars.js/compare/v1.0.11...v1.0.12}{\tt Commits}

\subsection*{v1.\+0.\+11 / 1.\+0.\+0-\/rc4 -\/ May 13 2013}
...
\subsection*{v1.\+0.\+10 -\/ Node -\/ Feb 27 2013}
...
\subsection*{v1.\+0.\+9 -\/ Node -\/ Feb 15 2013}
...
\subsection*{1.\+0.\+0-\/rc3 -\/ Browser -\/ Feb 14 2013}
